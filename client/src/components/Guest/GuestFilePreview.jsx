  ...
  >
    Create an account
      ...
      {previewFile && (
        ...
        >
          <div 
            className="bg-white dark:bg-gray-800 p-6 rounded shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto relative"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex justify-between items-start mb-4">
              <h3 className="text-lg font-bold pr-8 break-all">{previewFile.name}</h3>
              <button
                type="button"
                onClick={() => setPreviewFile(null)}
            ...
            {previewFile.type.startsWith("video/") && (
              <video controls className="w-full h-auto max-h-[60vh] rounded mb-4">
            ...
            <div className="mt-4 flex justify-end border-t border-gray-200 dark:border-gray-700 pt-4">
              <button
                type="button"
                onClick={() => setPreviewFile(null)}
                className="px-6 py-2 text-white bg-red-600 rounded-lg hover:bg-red-700 transition font-medium shadow-sm z-10 relative"
              >
                Close
              </button>
            </div>
